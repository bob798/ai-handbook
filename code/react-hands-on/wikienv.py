...
class WikiEnv(gym.Env):
  ...
  def search_step(self, entity):
    ...
    old_time = time.time()
    # Wikimedia now requires a User-Agent (2024 policy) — original code omitted it and gets 403.
    response_text = requests.get(
        search_url,
        headers={"User-Agent": "ReAct-hands-on/1.0 (learn-ai-engineering; contact: xbb798@gmail.com)"},
        timeout=20,
    ).text
